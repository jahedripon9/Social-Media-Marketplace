...
const ChatBox = () => {
    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-100 flex items-center justify-center sm:p-4">
            <div className="bg-white sm:rounded-lg shadow-2xl w-full max-w-2xl h-screen sm:h-[400px] flex flex-col">
                {/*Header */}
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex items-center justify-center h-full">
                            <div className="text-center">
                                ...
                                <p className='text-sm text-gray-400'>Start the conversational!</p>
                            </div>
                        </div>
                    ) : (
                ...
                {chat?.listing?.status === "active" ?
                    ...
                    (
                        <div className="p-4 bg-white border-t border-gray-200 rounded-b-lg">
                            <p className="text-sm text-gray-500 text-center">{chat ? `Listing is ${chat?.listing?.status}` : "Loading chat ..."}</p>
                        </div>
                    )
                }
            </div >
